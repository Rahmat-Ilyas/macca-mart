...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Analisis Penjualan /</span> Produk Paling Laku</h4>

        <!-- Basic Bootstrap Table -->
        <div class="card">
            <h5 class="card-header pb-3">Produk Paling Laku</h5>
            <hr>
            <div class="row">
                <div class="col-md-8">
                    <div class="card-datatable table-responsive px-4 pb-4">
                        ...
                        <hr>
                        <h5 class="card-title mb-0 pl-0 pl-sm-2 p-2 mb-2">Top 10 Produk Paling Laku per <span
                ...
                <div class="col-md-4">
                    <h4 class="text-center mt-4">Produk Paling Laku</h4>
...
@section('javascript')
    <script>
        $(document).ready(function() {
            $('#produk-paling-laku').addClass('active').parents('.this-sub').addClass('active open');
            $(".select2").select2();
